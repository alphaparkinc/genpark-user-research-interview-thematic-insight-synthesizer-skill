# genpark-user-research-interview-thematic-insight-synthesizer-skill
...
> **GenPark AI Agent Skill** -- Conversational user research transcript analyzer & thematic insight clusterer
